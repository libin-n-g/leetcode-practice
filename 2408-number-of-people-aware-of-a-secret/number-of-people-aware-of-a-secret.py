    ...
    def peopleAwareOfSecret(self, n: int, delay: int, forget: int) -> int:
        ...
        for day in range(1, n + 1):
            if new_people_each_day[day] > 0:
                ...
                # Calculate when these people can start sharing (after delay)
                # and continue sharing until they forget
        ...
        # Use modulo to prevent overflow as per problem requirements
        MOD = 10**9 + 7
